 ...
 * @author dylan
 */
public class VariableMipsArreglo extends VariableMips{
    ...
    public VariableMipsArreglo(String pTipo, String pValor, String pNombre, int pPosicionEnLaPila, String pEtiquetaData){
